...
if (!class_exists('Memcached')) {
    class Memcached {
        ...
        public function addServer($host, $port) { return false; }
        public function get($key) { return false; }
        public function set($key, $value) { return false; }
        public function getResultCode() { return self::RES_SUCCESS; }
    }
}
...
function load_config(): void
{
	...
	define('RESET_SUPERADMIN_PASSWORD', false); // Set to true temporarily to reset admin password
...
function credit() : string {
	return '<small><br><br><a target="_blank" href="https://github.com/TheInternetGod/Anon-Chat" rel="noreferrer noopener">ANON CHAT-PHP - ' . VERSION . '</a></small>';
}
...
if($dbversion<7){
	// Check if the column 'code' exists before trying to add it
	$columnCheck = $db->query("SHOW COLUMNS FROM " . PREFIX . "captcha LIKE 'code'");
...
// Continue with your other database version checks if any...
